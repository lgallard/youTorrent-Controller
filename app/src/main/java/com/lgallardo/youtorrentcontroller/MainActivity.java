...
//            drawerList.setItemChecked(0, true);
    ...
    public void onResume() {
        ...
        try {
            ...
            if (fm.getBackStackEntryCount() == 0 && firstFragment.getSecondFragmentContainer() == R.id.one_frame && fm.findFragmentById(R.id.one_frame) instanceof com.lgallardo.youtorrentcontroller.ItemstFragment) {
...
//                    Log.d("Debug", "MainActivity - refreshing");
    ...
    private class qBittorrentCommand extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!("startSelected".equals(result)) && !("pauseSelected".equals(result)) && !("stopSelected".equals(result)) && !("deleteSelected".equals(result)) && !("deleteDriveSelected".equals(result)) && !("setUploadRateLimit".equals(result)) && !("setDownloadRateLimit".equals(result)) && !("recheckSelected".equals(result))) {
